...
export default function ContactPage() {
  return (
    <div id="contact-view" className="bg-[#F4F4F2] text-slate-800 min-h-screen pt-6 sm:pt-8 md:pt-12 pb-14 sm:pb-16 md:pb-24 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full overflow-hidden">
      <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto">
        ...
        {/* MAIN CONTACT LAYOUT */}
        <motion.div
          className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 lg:gap-10 items-stretch"
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
          viewport={viewportOnce}
        >
          ...
          <div className="lg:col-span-6 flex flex-col justify-between space-y-6">
            ...
            <div className="flex items-center gap-2.5 pb-2">
              <span className="p-2 bg-[#831238]/10 text-[#831238] rounded-md">
                <MapPin className="w-5 h-5" />
              </span>
              <div>
                <h2 className="text-lg sm:text-xl font-serif font-extrabold italic text-[#831238] tracking-tight">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white p-4 sm:p-5 md:p-6 transition-all duration-300 shadow-md hover:shadow-lg group rounded-lg">
              ...
              {/* Contact Person 3 Card (Borderless) */}
              <div className="bg-white p-4 sm:p-5 md:p-6 transition-all duration-300 shadow-md hover:shadow-lg group rounded-lg">
                <div className="flex items-start justify-between gap-2 mb-2">
                  <div>
                    <h3 className="text-base sm:text-lg font-serif font-extrabold italic text-[#831238] group-hover:text-[#620a27] transition-colors">
                    ...
                    <div className="inline-flex items-center gap-1.5 mt-1 px-2.5 py-0.5 bg-[#831238]/10 text-[#831238] text-xs font-bold font-sans rounded">
                      <User className="w-3 h-3 text-[#831238]" />
                      <span>Co-Coordinator | Assistant Professor (Research)</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="lg:col-span-6 flex flex-col h-full min-h-[280px] sm:min-h-[360px] lg:min-h-full">
            <div className="bg-white border border-slate-300 overflow-hidden shadow-md h-full min-h-[280px] sm:min-h-[360px] relative rounded-lg">
              <iframe
