...
export default function HomePage() {
  return (
    <div id="home-view" className="bg-slate-50 text-slate-800 w-full overflow-hidden">
      {/* SECTION 1: HERO BANNER */}
      <section id="hero-banner" className="relative flex items-stretch overflow-hidden bg-white text-slate-900 border-b border-gray-200 w-full px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 items-center gap-6 lg:gap-10 xl:gap-14">
          {/* Hero Left Column */}
          <div className="lg:col-span-5 flex flex-col justify-center py-10 sm:py-8 md:py-12 lg:py-16 xl:py-20 bg-white relative z-20">
            <div className="text-[10px] sm:text-xs tracking-wider text-gray-400 mb-3 sm:mb-4 font-sans font-semibold">
              AICTE IDEA LAB // Sathyabama Institute
            </div>

            <div className="mb-4 sm:mb-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-100 border border-slate-200 text-slate-700 text-[10px] sm:text-xs font-sans tracking-wide rounded-lg">
                <Sparkles className="w-3.5 h-3.5 text-amber-500 animate-pulse" />
                <span>Transforming Ideas into Reality</span>
              </div>
            </div>

            <h1 className="text-2xl sm:text-[28px] md:text-[32px] xl:text-[36px] 2xl:text-[40px] font-extrabold leading-tight text-[#831238] mb-5 sm:mb-8 tracking-tight">
              Welcome to the <span className="text-[#831238]">AICTE IDEA LAB</span>
            </h1>

            <p className="text-xs sm:text-sm md:text-base text-slate-600 max-w-xl leading-relaxed mb-6 sm:mb-10 font-sans text-justify">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <Link
                href="/facilities"
                className="px-6 sm:px-8 py-3.5 sm:py-4 bg-[#831238] hover:bg-[#620a27] text-white text-xs sm:text-sm font-sans font-medium shadow-xl hover:scale-[1.02] active:scale-[0.98] transition-all rounded-lg flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          <div className="lg:col-span-7 flex items-center justify-center pb-10 sm:py-8 md:py-12 lg:py-16 xl:py-20 bg-white relative z-10">
            <div className="relative w-full overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.12)]">
              <img
                src={heroImage}
                alt="AICTE IDEA LAB"
      ...
      <section id="about-section" className="py-14 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6 text-slate-600 font-sans leading-relaxed text-sm md:text-base">
          ...
          <div className="lg:col-span-5 relative w-full">
            <div className="relative overflow-hidden shadow-xl">
              <img
                ...
                className="w-full h-[240px] sm:h-[350px] md:h-[420px] lg:h-[480px] object-cover"
              />
            </div>
          </div>
        </div>
      ...
      <section id="excellence-section" className="py-14 sm:py-20 md:py-24 bg-[#831238] border-y border-red-950 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto">
          <div className="max-w-3xl mb-10 sm:mb-16 space-y-3 sm:space-y-4">
            <h2 className="font-serif text-2xl sm:text-[28px] md:text-[30px] font-extrabold italic text-white tracking-tight">
              Bring Your Projects to Life
            </h2>
            <p className="text-xs sm:text-sm md:text-base text-white/80 leading-relaxed font-sans text-justify">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-2 hover:border-amber-300/40 group flex flex-col h-full transition-all duration-300 hover:-translate-y-1 p-5 sm:p-6">
              <div className="p-3 rounded-full bg-white/5 border border-white/10 text-amber-300 w-fit mb-4 sm:mb-5 group-hover:bg-amber-300 group-hover:text-[#831238] group-hover:border-amber-300 transition-all duration-300">
                <Scissors className="w-5 h-5 sm:w-6 sm:h-6" />
              </div>
              <h3 className="font-serif text-sm sm:text-base font-bold italic text-white leading-snug mb-2 sm:mb-3 group-hover:text-amber-300 transition-colors">
                CNC Milling &amp; Router Machines
              </h3>
      ...
      <section id="labs-section" className="py-14 sm:py-20 md:py-24 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            <h2 className="font-serif text-2xl sm:text-[28px] md:text-[30px] font-extrabold italic text-[#831238] leading-[1.1] tracking-tight">
      ...
      <section id="collab-section" className="py-14 sm:py-20 md:py-24 bg-[#F4F4F2] border-t border-slate-200 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-6 sm:space-y-8">
            <h2 className="font-serif text-2xl sm:text-[28px] md:text-[30px] font-extrabold italic text-[#831238] leading-[1.1] tracking-tight">
      ...
      <section id="tbi-initiatives-section" className="py-14 sm:py-20 bg-white border-t border-slate-200 px-4 sm:px-6 md:px-12 lg:px-16 xl:px-24 w-full overflow-hidden">
        <div className="w-full max-w-7xl 2xl:max-w-[1536px] mx-auto">
          ...
          <div className="relative w-full overflow-hidden">
            <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-8 sm:w-12 bg-gradient-to-r from-white to-transparent z-10" />
            <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-8 sm:w-12 bg-gradient-to-l from-white to-transparent z-10" />

            <div className="animate-marquee flex gap-4 sm:gap-6 items-center py-2">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white rounded-[6px] border border-slate-200 shadow-sm hover:shadow-md transition-all duration-300 w-[180px] sm:w-[240px] h-[90px] sm:h-[115px] p-3 sm:p-4 flex items-center justify-center shrink-0 group cursor-pointer select-none"
                >
                  <img
                    src={card.img}
                    alt={card.alt}
